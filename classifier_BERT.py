...
def preprocess_data(data_path):
    ...
    # update labels with numerical encoding
...
def f1_score_func(preds, labels):
    # f1 reasonable for class imbalance
...
if __name__ == '__main__':
    ...
    # add labels from the train/test split back into original dataframe
    ...
    for epoch in tqdm(range(1, CONFIG['train']['EPOCHS'] + 1)):
        ...
        torch.save(model.state_dict(), f'{MODEL_DIR}/BERT_ft_epoch_{epoch}.model')
